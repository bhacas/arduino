...
void setup () {
  ...
  mySwitch.send("000000110101010100000011");
...
static word homePage() {
  ...
  "HTTP/1.0 200 OK\r\n"
    ...
    "Pragma: no-cache\r\n"
    "\r\n"
    "{\"response\": {\"light1\": $D, \"blind\": $D, \"switch1\": $D, \"switch2\": $D, \"switch3\": $D, \"contactron1\": $D, \"outlet1\": $D, \"temperature\": $D, \"humidity\": $D, \"resets\": $D, \"replies\": $D}}"),
  light1, (int)(currentBlindState * 100 / BLIND_MOVE_TIME), switch1, switch2, switch3, contactron1, outlet1, (int)(temp*10), (int)humidity, resets, replies);
...
void switchOutput(String type, float value, boolean doNotifyMaster) {
  ...
  if (type == "outlet1") {
    if (value == 1) {
      ...
      //mySwitch.setProtocol(3);
      //mySwitch.send("010001101110010110110000");
      //Serial.println("sss");
    } else {
      outlet1 = 0;
      //mySwitch.setPulseLength(101);
      //mySwitch.setProtocol(3);
      //mySwitch.send("010010100011111010010000");
      //Serial.println("aaa");
    }
  }
}
