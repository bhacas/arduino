...
static byte mac[] = { 0x74,0x69,0x69,0x2D,0x31,0x05 };
IPAddress server(192, 168, 1, 10);
EthernetClient ethClient;
PubSubClient client(ethClient);

#define SERIAL 0
#define STATIC 0 // set to 1 to disable DHCP (adjust myip/gwip values below)home/sypialnia
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (topicStr == "home/sypialnia/light1/set") {
    if ((char)payload[0] == '0') {
      switchOutput("light1", 0, true);
    } else if ((char)payload[0] == '1') {
      switchOutput("light1", 1, true);
    } 
  } else if (topicStr == "home/sypialnia/light2/set") {
    if ((char)payload[0] == '0') {
      switchOutput("light2", 0, true);
    } else if ((char)payload[0] == '1') {
      switchOutput("light2", 1, true);
    }
  } else if (topicStr == "home/sypialnia/blind/set") {
    if ((char)payload[0] == '0') {
  ...
  } else if (topicStr == "home/sypialnia/blind/position") {
...
boolean reconnect() {
  if (client.connect("sypialnia")) {
    publishFloat("home/sypialnia/temp", (temp*10));
    publishFloat("home/sypialnia/humidity", humidity);
    publishFloat("home/sypialnia/light1", light1);
    publishFloat("home/sypialnia/switch2", switch2);
    publishFloat("home/sypialnia/blind", blindState);
    publishFloat("home/sypialnia/contactron1", contactron1);
    publishFloat("home/sypialnia/contactron2", contactron2);
    publishFloat("home/sypialnia/contactron3", contactron3);
    client.subscribe("home/sypialnia/light1/set");
    client.subscribe("home/sypialnia/light2/set");
    client.subscribe("home/sypialnia/blind/set");
    client.subscribe("home/sypialnia/blind/position");
  }
...
void switchOutput(String type, float value, boolean doNotifyMaster) {
  ...
  if (type == "light2") {
    ...
    publishFloat("home/sypialnia/light2", light2); 
  }
