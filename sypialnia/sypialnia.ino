...
static word homePage() {
  ...
  "HTTP/1.0 200 OK\r\n"
    ...
    "Pragma: no-cache\r\n"
    "\r\n"
    "{\"response\": {\"light1\": $D, \"blind\": $D, \"switch1\": $D, \"switch2\": $D, \"switch3\": $D, \"contactron1\": $D, \"contactron2\": $D, \"contactron3\": $D, \"temperature\": $D, \"humidity\": $D, \"resets\": $D, \"replies\": $D}}"),
  light1, (int)(currentBlindState * 100 / BLIND_MOVE_TIME), switch1, switch2, switch3, contactron1, contactron2, contactron3, (int)(temp*10), (int)humidity, resets, replies);
