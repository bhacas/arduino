...
static byte mac[] = { 0x74,0x69,0x69,0x2D,0x31,0x04 };
IPAddress server(192, 168, 1, 10);
EthernetClient ethClient;
PubSubClient client(ethClient);

#define SERIAL 0
#define STATIC 0 // set to 1 to disable DHCP (adjust myip/gwip values below)home/goscinny
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (topicStr == "home/goscinny/light1/set") {
    if ((char)payload[0] == '0') {
      switchOutput("light1", 0, true);
    } else if ((char)payload[0] == '1') {
      switchOutput("light1", 1, true);
    } 
  } else if (topicStr == "home/goscinny/light2/set") {
    if ((char)payload[0] == '0') {
      switchOutput("light2", 0, true);
    } else if ((char)payload[0] == '1') {
      switchOutput("light2", 1, true);
    }
  } else if (topicStr == "home/goscinny/blind/set") {
    if ((char)payload[0] == '0') {
  ...
  } else if (topicStr == "home/goscinny/blind/position") {
...
boolean reconnect() {
  if (client.connect("goscinny")) {
    publishFloat("home/goscinny/temp", (temp*10));
    publishFloat("home/goscinny/humidity", humidity);
    publishFloat("home/goscinny/light1", light1);
    publishFloat("home/goscinny/switch2", switch2);
    publishFloat("home/goscinny/blind", blindState);
    publishFloat("home/goscinny/contactron1", contactron1);
    publishFloat("home/goscinny/contactron2", contactron2);
    publishFloat("home/goscinny/contactron3", contactron3);
    client.subscribe("home/goscinny/light1/set");
    client.subscribe("home/goscinny/light2/set");
    client.subscribe("home/goscinny/blind/set");
    client.subscribe("home/goscinny/blind/position");
  }
...
void switchOutput(String type, float value, boolean doNotifyMaster) {
  ...
  if (type == "light2") {
    ...
    publishFloat("home/goscinny/light2", light2); 
  }
